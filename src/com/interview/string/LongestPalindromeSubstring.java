...
public class LongestPalindromeSubstring {
    ...
    public static void main(String args[]) {
       ...
       // System.out.println(lps.longestPalindromicSubstringLinear("bba".toCharArray()));
        System.out.println(lps.longestPalindromicSubstringLinear("abbababbaaaaaaa".toCharArray()));
