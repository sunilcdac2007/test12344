...
public class LexicographicRankInPermutation {
    ...
    private static int findNumberOfSmallerCharactersOnRight(int index,char []str){
        int count=0;
    ...
    public static void main(String args[]){
        ...
        System.out.println(findNumberOfSmallerCharactersOnRight(5,"STRING".toCharArray()));
