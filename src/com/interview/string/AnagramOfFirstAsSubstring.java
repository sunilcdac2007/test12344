...
public class AnagramOfFirstAsSubstring {
    ...
    public boolean isSubString(char str1[], char str2[]) {
        ...
        while (index < str2.length) {
            ...
            System.out.println("Current  size  "+currentCount.size() +" pos size "+pos.size() +" count size "+count.size() +" current length "+ curLen);
            System.out.println(" current map value ");
            for(Map.Entry<Character, Integer> ent : currentCount.entrySet())
            {
            	System.out.println(ent.getKey() +" value "+ent.getValue());
            }
            System.out.println(" pos map value ");
            for(Map.Entry<Character, Integer> ent : pos.entrySet())
            {
            	System.out.println(ent.getKey() +" value "+ent.getValue());
            }
    ...
    public static void main(String args[]){
        char str1[] = "wuabcd".toCharArray();
        char str2[] = "cdbaxyzabcuvw".toCharArray();
